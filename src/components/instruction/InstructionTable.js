    ...
    <section className="instruction_component">
      ...
      <section className="instruction_component-content">
        <span className="instruction_component-content--text">
          Tabela w programie zapewnia zaawansowane funkcje umożliwiające
          intuicyjne i efektywne zarządzanie danymi. Użytkownik może dostosować
          widok do swoich potrzeb poprzez sortowanie, filtrowanie oraz
          dynamiczne zarządzanie kolumnami. Dzięki temu możliwe jest szybkie
          odnalezienie istotnych informacji i uporządkowanie danych zgodnie z
          określonymi kryteriami.
        </span>
        <span className="instruction_component-content--text">
          Funkcja filtrowania pozwala na precyzyjne zawężenie wyników według
          wybranych wartości, a sortowanie umożliwia uporządkowanie danych w
          kolejności rosnącej lub malejącej. Użytkownik ma również pełną
          kontrolę nad strukturą tabeli – może ukrywać i ponownie wyświetlać
          kolumny, zmieniać ich kolejność oraz dostosowywać szerokość, co
          pozwala na optymalne wykorzystanie przestrzeni roboczej.
        </span>
        <span className="instruction_component-content--text">
          Interfejs tabeli został zaprojektowany w sposób przejrzysty i
          przyjazny, co ułatwia nawigację oraz pracę z dużymi zbiorami danych.
          Wszystkie zmiany w układzie tabeli odbywają się w czasie rzeczywistym,
          zapewniając płynność działania i komfort użytkowania.
        </span>
        <span className="instruction_component-content--text">
          Bez względu na opcję w menu która zostanie wybrana zostaną wczytane
          tylko te dane, do których jako użytkownik masz dostęp. Może się
          zdarzyć sytuacja, że pojawi się tabela z informacją brak danych –
        ...
        >
          {`b) `}
          <span className="instruction_component-content--element">Pilne</span>
        ...
        >
          ...
          {` - tylko dokumenty rozliczone, których wartość jest równa zero,`}
        </span>
        <span
          className="instruction_component-content--text"
          style={{ marginLeft: "20px" }}
        ...
        >
          {`e) `}
          <span className="instruction_component-content--element">KRD</span>
        ...
        <div className="instruction_custom-image">
          <img
            src="/instruction_image/table.png"
            alt="Logo"
        ...
        <br />
        <span className="instruction_component-content--title">
        ...
        <section className="instruction_component__wrapper">
          ...
          <img
            src="/instruction_image/szukaj.png"
            alt="Logo"
            className="w-32 h-auto"
        ...
        <span className="instruction_component-content--text">
          Wpisując odpowiednie frazy, słowa czy znaki zostaną wyświetlone tylko
          wiersze, które je zawierają, opcja szukaj ma ponadto możliwość zmiany
          wyszukiwania tekstu, po kliknięciu w lupę rozwinie się podmenu:
        </span>
        <span
          className="instruction_component-content--text"
          style={{ marginLeft: "20px" }}
        ...
        <span className="instruction_component-content--text">
          Tabela może zostać powiększona do pełnej wartości okna, wyłączają menu
        </span>
        <section className="instruction_component__wrapper">
          <FcInfo />
          <span
        ...
        <span className="instruction_component-content--text">
          Ta opcja pozwala na pełną kontrolę nad wyświetlaną tabelą, dostępne
          opcje:
        </span>
        <span
          className="instruction_component-content--text"
        ...
        <span className="instruction_component-content--text">
          Opis kolumn możliwych do włączenia w tabeli (kolumny są przypisane dla
          danych obszarów np. SERWIS, CZĘŚCI itd.) i użytkownik działu części
          może nie mieć możliwości włączenia kolumny 100VAT – zarezerwowanego
          dla BLACHARNI:
        </span>
        <span
          className="instruction_component-content--text"
        ...
        <span className="instruction_component-content--text">
          Pozwala na swobodne przemieszczanie się między stronami tabeli, można
          również wybrać ile dokumentów ma się wyświetlać na stronie (od 10 do
          100)
        </span>
        ...
        <section className="instruction_component__wrapper">
          ...
          <img
            src="/instruction_image/ctrlC.png"
            alt="Logo"
            className="w-32 h-auto"
            style={{ maxWidth: "50vw", height: "auto" }}
          />
        ...
        <span className="instruction_component-content--text">
          kliknięcie lewym przyciskiem w wartość komórki kopiuje zawartość do
          schowka (taki ctrl+c).
        </span>
        ...
        <span className="instruction_component-content--text">
          Zmiana szerokości kolumn – pomiędzy komórkami nagłówka, jest
          pogrubiona kreska, wystarczy „złapać” ja lewym przyciskiem myszy i
          zmniejszyć lub powiększyć kolumny, zmiana wielkość może spowodować
          zmniejszenie/powiększenie wysokości wierszy, w zależności ile danych
          się wyświetla w danej komórce.
        </span>
        ...
        <section className="instruction_component__wrapper">
          ...
          <img
            src="/instruction_image/sort.png"
            alt="Logo"
            className="w-32 h-auto"
            style={{ maxWidth: "50vw", height: "auto" }}
          />
        ...
        <span className="instruction_component-content--text">
          kliknięcie w nagłówek tabeli np. w kolumnę Faktura czy Data FV
          następuje sortowanie tabeli, od największych, od najmniejszych, trzeci
          kliknięcie to wyłączenie sortowania (kolejność sortowania wyznacza
          ikona strzałek).
        </span>
        ...
        <section className="instruction_component__wrapper">
          ...
          <img
            src="/instruction_image/filtr.png"
            alt="Logo"
            className="w-32 h-auto"
            style={{ maxWidth: "50vw", height: "auto" }}
          />
        ...
        <span className="instruction_component-content--text">
          jeśli dla danej kolumny jest przewidziane filtrowanie to w komórce
          nagłówka znajduje się wyszarzony symbol lejka.
          <br />I klikając w niego możemy filtrować tabelę wg przewidzianego
          filtra: - w kolumnie z datami pojawiają się dwa okienka gdzie można
          wybrać datę początkową i końcową lub tylko pocztąkową/końcową - filtr
          pojedynczego wyboru - duża część filtrów to możliwość wielokrotnego
          wyboru (z podpowiedzią ile dokumentów otrzymamy)
        </span>
