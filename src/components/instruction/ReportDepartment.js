    ...
    <section className="instruction_custom">
      ...
      <section className="instruction_custom-content">
        <span className="instruction_custom-content--text">
          Jeżeli masz dostęp do więcej niż jednego działu, system wyświetli
          dodatkowe podsumowanie, obejmujące wszystkie dostępne dla Ciebie
          działy. Zestawienie to pozwoli na szybki przegląd danych z różnych
          obszarów w jednym miejscu. Widok ten jest generowany automatycznie na
          podstawie Twoich uprawnień i obejmuje wszystkie sekcje, do których
          masz dostęp. Dzięki temu możesz analizować informacje w szerszym
          kontekście bez konieczności przełączania się między poszczególnymi
          działami.
        </span>
        <span className="instruction_custom-content--text">
        ...
        <div className="instruction_custom-image">
          <img
            src="/instruction_image/report_dep.png"
            alt="Logo"
        ...
        >
          {`• `}
          <span className="instruction_component-content--element">
            Kwota nieprzeterminowanych FV – BL{" "}
          </span>
        ...
        >
          {`• `}
          <span className="instruction_component-content--element">
            Ilość wszystkich przeterminowanych FV
          </span>
        ...
        >
          {`• `}
          <span className="instruction_component-content--element">
            Kwota wszystkich nieprzeterminowanych FV
          </span>
        ...
        >
          {`• `}
          <span className="instruction_component-content--element">
            Stan należności bez kancelarii w %
          </span>
        ...
        >
          {`• `}
          <span className="instruction_component-content--element">
            Kwota przeterminowanych FV bez kancelarii
          </span>
        ...
        >
          {`• `}
          <span className="instruction_component-content--element">
            Ilość przeterminowanych FV bez kancelarii
          </span>
        ...
        >
          {`• `}
          <span className="instruction_component-content--element">
            Kwota nieprzeterminowanych FV bez kancelarii
          </span>
