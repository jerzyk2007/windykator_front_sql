    ...
    return (
        <section className='instruction_custom'>
            ...
            <section className='instruction_custom-content'>
                <span className='instruction_custom-content--text'>System wyświetli listę wszystkich Doradców w dziale lub działach do których masz przyznany dostęp, Doradca może pojawić się wielokrotnie jeśli wystawiał dokumenty w kilku działach, a Ty masz dostęp do każdego z nich. Zestawienie to pozwoli na szybki przegląd danych dotyczących doradców w różnych kontekstach, nawet jeśli są przypisani do różnych obszarów. Widok ten jest generowany automatycznie na podstawie Twoich uprawnień i obejmuje tylko tych doradców, do których masz dostęp w ramach przypisanych działów. Dzięki temu możesz analizować informacje w szerszym kontekście bez konieczności przełączania się między poszczególnymi sekcjami, a każda pozycja będzie odpowiednio przypisana do swojego działu.
                </span>
                ...
                <div className='instruction_custom-image'>
                    <img src="/instruction_image/report_adv.png" alt="Logo" className="w-32 h-auto" />
                </div>
                ...
                <span className='instruction_component-content--text'
                    style={{ marginLeft: "20px" }}
                >{`• `}
                    <span className='instruction_component-content--element'>Stan należności w %</span>
                ...
                <span className='instruction_component-content--text'
                    style={{ marginLeft: "20px" }}
                >{`• `}
                    <span className='instruction_component-content--element'>Ilość przeterminowanych FV</span>
                    {` - ilość przeterminowanych i nierozliczonych faktur,`}
                </span>
                <span className='instruction_component-content--text'
                    style={{ marginLeft: "20px" }}
                >{`• `}
                    <span className='instruction_component-content--element'>Kwota nieprzeterminowanych FV</span>
                ...
                <span className='instruction_component-content--text'
                    style={{ marginLeft: "20px" }}
                >{`• `}
                    <span className='instruction_component-content--element'>Kwota nierozliczonych FV – błędy doradcy i dokumentacji </span>
                ...
                <span className='instruction_component-content--text'
                    style={{ marginLeft: "20px" }}
                >{`• `}
                    <span className='instruction_component-content--element'>Ilość nierozliczonych FV – błędy Doradcy i dokumentacji</span>
                    {` - jw. podana jest ilość takich spraw,`}
                </span>
            </section>
        </section>
