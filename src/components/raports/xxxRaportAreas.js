        ...
        <section className="raport-areas">
          <section className="raport-areas__container">
            <section className="raport-areas__container-item">
              <span className="raport-areas__container-title">
                Wybierz firmę:
              </span>
              ...
              <section className="raport-areas__container-select">
                {raportInfo.company.map((item, index) => {
                  const color =
                    raportInfo.colorCheckBox[
                      index % raportInfo.colorCheckBox.length
                    ];
                  return (
                    <Checkbox
                      className="raport-areas__container-select--item"
                      key={index}
                      label={item}
                      color={color}
                      defaultChecked
          ...
          <Button color="secondary" variant="contained" onClick={getRaport}>
            Pobierz
          </Button>
        </section>
      )}
