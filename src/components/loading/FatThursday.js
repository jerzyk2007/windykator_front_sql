...
//         if (distance < mouth.size + this.size) {
//           this.eat();
//         }
//       }
//       eat() {
//         // Efekt cząsteczek (cukier puder / lukier)
//         for (let i = 0; i < 10; i++) {
//           particles.push(new Particle(this.x, this.y, this.type.icing));
//         }
//         setScore((s) => s + 1);
//         setCalories((c) => c + Math.floor(Math.random() * 100 + 300));
//         this.reset();
//         mouth.open = 20; // Animacja otwarcia buzi
//       }
//       draw() {
//         ctx.save();
...
//         // Posypka
//         ctx.fillStyle = this.type.sprinkle;
//         for (let i = 0; i < 8; i++) {
//           ctx.fillRect(Math.sin(i) * 15, Math.cos(i) * 10 - 5, 6, 2);
//         }
...
//           <span className="label">Zjedzone pączki:</span>
//           <span className="value">{score}</span>
//         </div>
//         <div className="stat-box">
//           <span className="label">Licznik kalorii:</span>
...
//         <p className="status-text">Ładowanie pączków do systemu... 🍩</p>
//         <p className="status-text">Proszę czekać ... 🍩</p>
//         {/* {calories < 2000 ? (
//           <p className="status-text">Ładowanie pączków do systemu... 🍩</p>
//         ) : (
//           <p className="status-text error-text">
//             BŁĄD: PRZEKROCZONO POZIOM LUKRU W ORGANIZMIE! ⚠️
//           </p>
//         )} */}
//         <p className="sub-text">Poruszaj myszką, aby łapać kalorie!</p>
//       </div>
//     </div>
//   );
// };
