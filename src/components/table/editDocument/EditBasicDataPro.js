...
//   style = {},
//   titleClassName = "", // dodajemy to, żeby obsłużyć klasę CSS
//   onDoubleClick, // dodajemy to, aby odebrać funkcję
// }) => {
...
//   const handleEditContarctor = () => {
//     setIsContractorEditing(true);
//     console.log(rowData);
//   };
...
//             <DataRow
//               title="Nr autoryzacji:"
//               children={rowData.NR_AUTORYZACJI}
//             />
//           )}
...
//           <DataRow
//             title="Data przekazania"
//             children={rowData.DATA_PRZEKAZANIA}
//           />
...
//             children={rowData.TERMIN_PLATNOSCI}
//           />
//           <DataRow
//             title="Kontrahent:"
...
//           <DataRow
//             title="Kontrahent:"
//             titleClassName="ertp-label-clickable" // Dodajemy klasę do hovera
//             onDoubleClick={handleEditContarctor} // Dodajemy akcję
//             style={getScrollStyle(rowData.KONTRAHENT)}
//             contentClass={
//               rowData?.KONTRAHENT?.length > 70
//                 ? "ertp-data-row__value ertp-data-row__value--scrollable"
...
const VindexView = ({ rowData, onEdit }) => (
  <section className="ertp-data-section">
    <DataRow title="Faktura:" children={rowData.NUMER_FV} />
    <DataRow title="Data wystawienia:" children={rowData.DATA_FV} />
...
const EditBasicDataPro = (props) => {
  const { rowData, profile, setRowData, login, handleAddNote, context } = props;
  const axiosPrivateIntercept = useAxiosPrivateIntercept();
