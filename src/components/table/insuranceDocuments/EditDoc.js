...
//   // Funkcja formatująca walutę (taka sama jak w AddDoc)
...
//                 {/* NOWE POLE: KWOTA */}
//                 <div className="doc-info">
//                   <span className="doc-label">Kwota</span>
//                   <p className="doc-value">{formatToPLN(doc.KWOTA_DOKUMENT)}</p>
//                 </div>

//                 {/* POLE: NALEŻNOŚĆ */}
//                 <div className="doc-info">
//                   <span className="doc-label">Należność</span>
//                   <p
//                     className="doc-value"
//                     style={{ fontWeight: "bold", color: "#2e7d32" }}
//                   >
//                     {formatToPLN(doc.NALEZNOSC)}
//                   </p>
//                 </div>
