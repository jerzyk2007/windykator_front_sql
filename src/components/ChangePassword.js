...
const ChangePassword = () => {
    ...
    return (
        <section className="change_password">
            {errMsg && <p className="change_password-error-message" ref={errRef}>{errMsg}</p>}
            {!errMsg && <h1 className="change_password-title">Zmiana hasła</h1>}
            <h3 className="change_user_name-info">Jeśli zmiana hasła zakończy się sukcesem to zostaniesz automatycznie wylogowany</h3>
            <form className="change_password__container" onSubmit={handleSubmit}>
                ...
                />
                {passwordFocus && !validPassword && <p className="change_password__container-instructions" >
                ...
                />
                {matchPasswordFocus && !validMatchPassword && <p className="change_password__container-instructions" >
                    <FontAwesomeIcon icon={faInfoCircle} />
