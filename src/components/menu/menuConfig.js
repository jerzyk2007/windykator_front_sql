...
export const menuItems = [
  {
    title: "Tabelka",
    roles: [100, 2000], // Rozszerzone, by rodzic pozwalał wejść głębiej
    submenu: [
      { label: "Aktualne", path: "/actual-table", roles: [100, 2000] },
      { label: "Pilne", path: "/critical-table", roles: [100, 2000] },
      { label: "Zobowiązania", path: "/obligations-table", roles: [100, 2000] },
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Wszystkie", path: "/all-insurance-table", roles: [150, 350] },
      {
        label: "OW - rozliczone",
        path: "/settled-collection-charges",
        roles: [150],
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Instrukcja obsługi", path: "/instruction", roles: [1, 2000] },
      { label: "Dodaj użytkownika", path: "/register", roles: [1000, 2000] },
      { label: "Zmień hasło", path: "/change-password", roles: [1, 2000] },
      { label: "Wyloguj", action: "logout" },
    ],
  },
];
